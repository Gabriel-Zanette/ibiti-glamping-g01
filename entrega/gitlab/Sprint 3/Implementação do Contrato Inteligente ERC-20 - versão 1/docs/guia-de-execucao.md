...
Selecione Browser Extension / MetaMask na rede Sepolia. A v2 já está publicada em `0xaA6C2902A7f50Dd8C4E8a68de67EA97817Aac030`, bloco 11684811. Use esse endereço para operar a entrega atual. A v1 em `0x111B510517087a76eF7D1914849898A0718A2734` é histórica. Recibos, parâmetros e fontes estão no repositório, em `docs/deploy-modelo-pessoa.md`.
