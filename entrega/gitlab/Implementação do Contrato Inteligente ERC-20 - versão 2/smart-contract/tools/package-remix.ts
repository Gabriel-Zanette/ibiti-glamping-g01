...
for (const name of ['regras-de-negocio-para-contrato.md','evolucao-v1-v2.md','relatorio-de-testes.md','premissas-e-pendencias.md','validacao-v3.json']) files['docs/'+name]=readFileSync(resolve(root,'docs',name));
