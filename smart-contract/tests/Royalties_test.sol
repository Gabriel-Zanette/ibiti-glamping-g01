...
contract RoyaltiesTest {
    ...
    function testCompraAtualNaoRecebeSemestrePassado() public returns(bool) {
        token.reportRevenue(1_000_000,keccak256("relatorio"));
        require(token.royaltyDue(1,address(alice))==0 && token.royaltyDue(1,address(this))==150_000);return true;
    }
    function testArredondamento() public returns(bool) {
        ...
        require(p.royaltyAmount==16 && p.totalDue==16);return true;
    }
