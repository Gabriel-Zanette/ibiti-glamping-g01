...
> **Revisão de 10/09/2026:** implementar/validar o fluxo de [`offchain/`](../offchain/README.md). Onde tarefas antigas mencionam resgate on-chain/voucher, usar pedido e cadastro por pessoa. Não executar `markRedeemed` no fluxo novo. SVGs/PNGs devem ser regenerados; o [roteiro atual de Sepolia](../smart-contract/docs/deploy-modelo-pessoa.md) separa deploy pendente de teste local.
