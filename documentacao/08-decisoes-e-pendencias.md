...
> **25/09/2026 — jornada unificada solicitada:** o usuário reafirmou o rateio por tempo e os demais aceites, mantendo cancelamento em análise. Solicitou waitlist funcional, decisão por administrador com login individual, ficha do cliente e integração do mesmo cadastro até compra/cotas. [Planejamento e comparações](../docs/decisoes/2026-09-25-jornada-unificada-waitlist.md). Prazo de cinco dias úteis, mecanismo de acesso e checklist foram propostos, não aprovados automaticamente. Memorando v2 será enviado ao final das modificações.

> **Estado vigente do desenho, após as 12 anotações de 23/09:** [consolidação atual](../docs/decisoes/2026-09-23-consolidacao-das-anotacoes.md). Royalties proporcionais ao tempo de posse ([ADR 0003](../docs/adr/0003-royalties-proporcionais-ao-tempo.md)); mercado secundário retirado ([ADR 0004](../docs/adr/0004-sem-mercado-secundario.md)); identificação híbrida e fluxo completo de recuperação aceitos. A compra primária atômica permanece, ainda sem checkout integrado. As anotações já foram recebidas; o memorando v1 já foi localizado. O histórico abaixo não prevalece sobre essas decisões e não descreve implementação já alterada.

> **Respostas mais recentes, 23/09/2026:** [Q3–Q13](../docs/decisoes/2026-09-23-respostas-q3-q13.md). Pré-venda removida; aceitos revisão conjunta nos atos críticos, pausa por atividade, recuperação em sete dias corridos e processos externos documentados/simulados. Reserva protegida pode ser liberada para venda; comprometimento de cotas ocorre off-chain. Tesouraria estável 2 de 3 aceita no núcleo, aguardando observações complementares. Q10 e Q13 permanecem abertos; Q11 foi indicado como retirado, com alcance dependente das anotações. São decisões de desenho, não declaração de mudança já executada no contrato.

> **23/09/2026 — fonte localizada e contexto corrigido:** o [memorando v1 da Sprint 3](../docs/referencias/memorando-v1-sprint3/README.md) foi consultado diretamente no GitLab. Suas páginas 11–12 fixam corte no reporte na v1; a mudança para fechamento ainda é proposta. O [registro de respostas e Q1/Q2](../docs/decisoes/2026-09-23-anotacoes-e-q1-q2.md) consolida as mensagens disponíveis. As 12 anotações mostradas no aplicativo são distintas dessas respostas e seu conteúdo ainda não foi recuperado. A imagem registra pedido de reformulação de Q1 e concordância com a recomendação de Q2 condicionada à verificação durante o período.
